...
export async function executeChatTool(
  ...
  switch (name) {
    ...
    case "search_knowledge_base": {
      // RAG-ready stub — replace with vector search in production
      ...
      const articles: Record<string, string> = {
        ...
        voice:
          "Voice Agent provides real-time STT → OpenAI → TTS pipeline with Deepgram and ElevenLabs integration.",
        calling:
