...
export function VoiceAgentPanel() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Voice Agent"
        description="Real-time voice AI — Deepgram STT, Gemini reasoning, ElevenLabs TTS"
      >
      ...
      {providersReady === false && (
        <div className="flex items-center gap-2 rounded-lg border border-destructive/50 bg-destructive/10 p-4 text-sm text-destructive">
          ...
          Voice agent requires GEMINI_API_KEY, DEEPGRAM_API_KEY, and ELEVENLABS_API_KEY in backend
          .env
        </div>
      )}
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Microphone → Deepgram → Gemini → ElevenLabs</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <ul className="text-xs text-muted-foreground space-y-1">
              ...
              <li>• Gemini 2.0 Flash with function calling</li>
